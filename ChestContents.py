...
class ChestForm(Form):
    ...
    def __init__(self, contents, destid):
        self.Contents = contents
        self.DestinationContainer = destid
    ...
    def btnGetPressed(self, sender, args):
        ...
        Items.Move(int(serial, 0), self.DestinationContainer, 0)
...
Misc.SendMessage('Target a container to put moved items in.', 76)  
destid = Target.PromptTarget()

if contid > -1:
    if destid == -1:
        destid = Player.Backpack.Serial
    ...
    if contents == []:
        ...
        form = ChestForm(contents, destid)
